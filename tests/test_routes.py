...
POST /products - Confirms creation of a product and returns the product with its id
PUT /products/{id} - Updates a product record based on its id
DELETE /products/{id} - Deletes a product record based on its id
"""
